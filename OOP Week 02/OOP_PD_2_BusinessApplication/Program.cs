...
namespace OOP_PD_2_BusinessApplication
{
    class Program
    {
        ...
        public static void LoadData(List<credentials> Users)
        {
            string record;
        ...
        public static void StoreData(string name, string password, string role)
        {
            StreamWriter file = new StreamWriter("E:\\OOPs\\Lab01\\OOP PD 1\\records.txt", true);
            file.WriteLine();
            file.Write(name + "," + password + "," + role);
            file.Flush();
            file.Close();
        }
        ...
        public static bool CheckAccount(string name, string password, List<credentials> Users)
        {
            int foundIndex = -1;
        ...
        public static string CheckRole(string name, string password, List<credentials> Users)
        {
            int foundIndex = -1;
            for (int index = 0; index < Users.Count; index++)
            {
