...
using OOP_PD_4_BusinessApplication_2022CS1.BL;

namespace OOP_PD_4_BusinessApplication_2022CS1
{
    class Program
    {
        ...
        {
            RailwayManagementSystem_2022CS1();
            Console.ReadKey();
        }
        public static void RailwayManagementSystem_2022CS1()
        {
            ...
            while (true)
            {
                ...
                if (option == 1)
                {
                    ...
                    MyUser newUser = TakeInputWithoutRole();
                    MyUser FoundUser = newUser.UserExists(Users);
                    if(FoundUser == null)
                    {
                    ...
                    else if(FoundUser.CheckRole() == "Admin" || FoundUser.CheckRole() == "Admin")
                    {
                        while (true)
                        {
                            ClearScreen();
                            PrintHeader();
                            Console.WriteLine("Assalam-o-Alaikum! " + FoundUser.name);
                            ...
                            if (adminMenu == 1)
                            {
                                ...
                                TrainInfo FoundTrain = newTrain.TrainExists(Trains);
                                if (FoundTrain != null)
                                {
                                ...
                                else
                                {
                                    ...
                                    StoreTrainInList(Trains, FoundTrain);
                                    StoreTrainInFile(FoundTrain);
                            ...
                            else if (adminMenu == 3)
                            {
                                while (true)
                                {
                                    ...
                                    if (UpdateOption == 1)
                                    {
                                        ...
                                        Console.WriteLine("Enter Train number:                          ");
                                        TrainNo = Console.ReadLine();
                                        int TrainIndex = FindTrainFromList(Trains, TrainNo);
                                        if (TrainIndex != -1)
                                        {
                            ...
                            else if (adminMenu == 12)
                            {
                                ...
                                Console.WriteLine();
                                MyUser newUser1 = TakeInputWithoutRole();
                                MyUser FoundUser1 = newUser1.UserExists(Users);
                                if (FoundUser != null)
                                {
                                ...
                                {
                                    newUser.role = "Admin";
                                    AddUserToList(Users, newUser1);
                                    storeDataInFile(newUser1);
        ...
        public static void AddUserToList(List<MyUser> Users, MyUser User)
        {
            Users.Add(User);
        }
        ...
        public static void StoreTrainInList(List<TrainInfo> Trains, TrainInfo Train)
        {
            Trains.Add(Train);
        }
        ...
        public static int FindTrainFromList(List<TrainInfo> Trains, string TrainNo)
        {
            for (int i = 0; i < Trains.Count; i++)
            {
                if (TrainNo == Trains[i].no)
                {
                    return i;
                }
            }
